...
Greg::Greg(int orientation,sf::RectangleShape& sol)
{
    _orientation = orientation;
    if (!_Texture.loadFromFile("sprite/sprite_gregoose.png"))//load de la texture du personnage
    {
        cout << "erreur" << endl;
    }
...
void Greg::debout(sf::RenderWindow& window,sf::RectangleShape hurtboxEnnemi){
    _cptanimjump = 0;
    ...
    {
    case 0:
        setSprite(0,892,165,269);
        break;
    case 1:
        setSprite(171,892,166,264);
        break;
    case 2:
        setSprite(340,892,166,264);
        break;
    case 3:
        setSprite(509,892,166,264);
        break;
    case 4:
        setSprite(679,892,166,264);
        break;
    case 5:
        _cptanimstatic=0;
        //setSprite(747,892,166,264);
        break;
    }
...
void Greg::avancer(sf::RenderWindow& window,sf::RectangleShape hurtboxEnnemi){
...
void Greg::reculer(sf::RenderWindow& window){
...
bool Greg::coupDePoing(sf::RectangleShape hurtboxEnnemi,bool& touche,sf::RenderWindow& window){
...
void Greg::prendCoup(bool& touche, sf::RenderWindow& window){
...
bool Greg::sauter(sf::RenderWindow& window,sf::RectangleShape hurtboxEnnemi){
    float v_grav = 1.7;
    _vitesseX = 20;
    sf::Time elapsed = _clockanim.getElapsedTime();
    int timeAnim = elapsed.asMilliseconds();
...
bool Greg::sauterAvancer(sf::RenderWindow& window,sf::RectangleShape hurtboxEnnemi){
     float v_grav = 1.7;
...
bool Greg::sauterArriere(sf::RenderWindow& window,sf::RectangleShape hurtboxEnnemi){
     float v_grav = 1.7;
    _vitesseX = -15*_orientation;
    sf::Time elapsed = _clockanim.getElapsedTime();
    int timeAnim = elapsed.asMilliseconds();
...
void Greg::seBaisser(sf::RenderWindow& window,sf::RectangleShape hurtboxEnnemi){
}
